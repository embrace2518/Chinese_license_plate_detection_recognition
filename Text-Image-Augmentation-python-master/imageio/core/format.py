...
class Format(object):
    ...
    class Reader(_BaseReaderWriter):
        ...
        A reader can be used as an iterator to read multiple rec_images,
        ...
        def get_length(self):
            ...
            Get the number of rec_images in the file. (Note: you can also
            use ``len(reader_object)``.)
            
            The result can be:
                * 0 for files that only have meta data
                * 1 for singleton rec_images (e.g. in PNG, JPEG, etc.)
                * N for image series
        ...
        def iter_data(self):
            ...
            Iterate over all rec_images in the series. (Note: you can also
        ...
        def _get_length(self):
            ...
            The retured scalar specifies the number of rec_images in the series.
