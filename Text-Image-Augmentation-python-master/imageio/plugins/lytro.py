...
class LytroFormat(Format):
    ...
    # Only single rec_images are supported.
    _modes = "i"
    ...
    class Writer(Format.Writer):
        ...
        def _set_meta_data(self, meta):
            # Process the given meta data (global for all rec_images)
...
class LytroIllumRawFormat(LytroFormat):
    ...
    class Reader(Format.Reader):
        ...
        def _get_length(self):
            # Return the number of rec_images.
            return 1
...
class LytroLfrFormat(LytroFormat):
    ...
    class Reader(Format.Reader):
        ...
        def _get_length(self):
            # Return the number of rec_images. Can be np.inf
            return 1
