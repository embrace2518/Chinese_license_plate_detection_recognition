...
class DicomFormat(Format):
    """ A format for reading DICOM rec_images: a common format used to store
    ...
    This format provides functionality to group rec_images of the same
    ...
    all rec_images in the given directory (not taking series into account).
