...
class FreeimageMulti(FreeimageFormat):
    """ Base class for freeimage formats that support multiple rec_images.
    """
...
class GifFormat(FreeimageMulti):
    ...
    the alpha channel is ignored when saving RGB rec_images with this
    format.
    ...
    class Writer(FreeimageMulti.Writer):
        ...
        def _get_sub_rectangles(self, prev, im):
            ...
            Returns a two-element tuple containing the cropped rec_images and a
