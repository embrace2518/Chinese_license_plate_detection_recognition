...
class IO_FLAGS(object):
    ...
    EXR_LC = 0x0040  # save rec_images with one luminance and two chroma channels,
...
class FIBitmap(FIBaseBitmap):
    ...
    def get_image_data(self):
        ...
        if len(shape) == 3 and isle and dtype.type == numpy.uint8:
            ...
            if shape[0] == 3:
                ...
                raise ValueError("Cannot handle rec_images of shape %s" % shape)
    ...
    def set_image_data(self, array):
        ...
        # The BGR[A] order is only used for 8bits per channel rec_images
