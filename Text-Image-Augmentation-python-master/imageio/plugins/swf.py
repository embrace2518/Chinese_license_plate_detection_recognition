...
class SWFFormat(Format):
    ...
    store a series of rec_images in a lossless format with good compression
    (zlib). The resulting rec_images can be shown as an animation using
    a flash player (such as the browser).

    SWF stores rec_images in RGBA format. RGB or grayscale rec_images are
    ...
    compress : bool
        ...
        the rec_images are already compressed. It will result in slower
    ...
    class Reader(Format.Reader):
        def _open(self, loop=False):
            ...
            # correspond to the number of rec_images.
    ...
    class Writer(Format.Writer):
        ...
        def _complete(self):
            # What if no rec_images were saved?
