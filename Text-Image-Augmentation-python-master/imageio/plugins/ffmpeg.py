...
""" Plugin that uses ffmpeg to read and write series of rec_images to
...
class FfmpegFormat(Format):
    ...
    size : str | tuple
        The frame size (i.e. resolution) to read the rec_images, e.g.
    ...
    pixelformat : str
        ...
        this to take effect. Note that the rec_images produced by this
    ...
    class Reader(Format.Reader):
        ...
        def _open(
            ...
            # For cameras, create thread that keeps reading the rec_images
            if self.request._video:
    ...
    class Writer(Format.Writer):
        ...
        def _append_data(self, im, meta):
            ...
            # Check size of image
            if size != self._size:
                raise ValueError("All rec_images in a movie should have same size")
            if depth != self._depth:
                raise ValueError(
                    "All rec_images in a movie should have same " "number of channels"
                )
