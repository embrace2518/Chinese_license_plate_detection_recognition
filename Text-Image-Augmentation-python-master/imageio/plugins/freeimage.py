...
class FreeimageFormat(Format):
    ...
    class Reader(Format.Reader):
        ...
        def _get_data(self, index):
            if index != 0:
                raise IndexError("This format only supports singleton rec_images.")
    ...
    class Writer(FreeimageFormat.Writer):
        ...
        def _append_data(self, im, meta):
            ...
            if not q:
                ...
                raise ValueError("Can only quantize RGB rec_images")
            elif q < 2 or q > 256:
...
class FreeimagePnmFormat(FreeimageFormat):
    ...
    rec_images, even with ASCII or binary coding.
