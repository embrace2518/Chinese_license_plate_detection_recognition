...
class DicomSeries(object):
    ...
    def description(self):
        ...
        if not info:  # pragma: no cover
            return "DicomSeries containing %i rec_images" % len(self)
    ...
    def __repr__(self):
        ...
        return "<DicomSeries with %i rec_images at %s>" % (len(self), adr)

    def get_numpy_array(self):
        """ Get (load) the data that this DicomSeries represents, and return
        it as a numpy array. If this serie contains multiple rec_images, the
    ...
    def _finish(self):
        ...
        This method checks:
          ...
          * that the dimensions of all rec_images match
          * that the pixel spacing of all rec_images match
        """
