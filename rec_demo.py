...
if __name__ == '__main__':
    ...
    # parser.add_argument('--image_path', type=str, default='rec_images/tmp6FC6.png', help='source')
    parser.add_argument('--image_path', type=str, default='/mnt/EPan/carPlate/@realTest2_noTraining/realrealTest',
                        help='source')
